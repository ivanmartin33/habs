...
// Palette used when creating habits (couleurs vives façon iOS).
export const COLORS = [
  '#0a84ff',
  '#30d158',
  '#ffd60a',
...
// Timestamp du dernier rappel reçu/tapé, pour le "depuis le dernier rappel".
const LAST_REMINDER_KEY = 'lastReminder.v1';
export const getLastReminder = () => load(LAST_REMINDER_KEY, 0);
export const saveLastReminder = (ts) => save(LAST_REMINDER_KEY, ts);
